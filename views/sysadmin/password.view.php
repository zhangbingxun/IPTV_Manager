					...
					<div class="form-group">
						<form method="post">
							...
							<div class="form-group">
								...
								<button class="btn btn-danger" type="submit" name="closesecret_key" value="" <?php if(empty(get_config('secret_key'))){echo 'disabled';} ?>><?php if (empty(get_config('secret_key'))){echo '安全码验证已关闭';} else {echo '关闭安全码验证';} ?></button>
							</div>
						</form>
						<hr>
						<form method="post">
