			...
			<div id="wrapper">
					...
					<div id="main">
							<article id="android">
								...
								<p>
									<ul class="actions">
										<li><a class="button primary icon solid fa-download" href="<?php echo $appurl; ?>">點播+直播版本 <?php echo 'V' . $appver; ?> 下載</a></li>
									<li><a class="button primary icon solid fa-download"  href="<?php echo $boxurl; ?>">直播版 <?php echo 'V' . $boxver; ?> 下載</a></li>
									</ul>
								</p>
							</article>
